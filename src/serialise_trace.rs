...
pub fn write(traces: &[Trace]) -> Vec<u8> {
    ...
    loop {
        ...
        ret.write_u16::<LE>(u16_from(corrects)).expect("writing to a vector");
    }
...
pub fn read<R: Read>(mut data: R) -> Result<Vec<Trace>> {
    ...
    loop {
        ...
        if 0 == first {
            ...
            ret.push(Trace::Actual(Code::Reference(Ref::new(dist, u16::from(run_minus_3 + 3)))));
        } else {
